...
static NSString *BalanceNotification = @"BalanceNotification";
...
@property (assign, nonatomic) BOOL isAppleCheck; // check cho trường hợp thằng apple nó duyệt
@property (strong, nonatomic) NSString *isAppleToken; // check cho trường hợp thằng apple nó duyệt
