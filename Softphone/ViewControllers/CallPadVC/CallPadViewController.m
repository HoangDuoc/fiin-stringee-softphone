...
- (IBAction)clearTapped:(UIButton *)sender {
    if (strPhoneNumber.length) {
        ...
        self.labelUsername.text = [[SPManager instance] findUsernameWithPhone:strPhoneNumber];
    }
...
- (IBAction)callTapped:(UIButton *)sender {
    ...
    if (!toPhoneNumber.length) {
        ...
        if (toPhoneNumber && toPhoneNumber.length) {
            ...
            self.labelUsername.text = [[SPManager instance] findUsernameWithPhone:toPhoneNumber];
